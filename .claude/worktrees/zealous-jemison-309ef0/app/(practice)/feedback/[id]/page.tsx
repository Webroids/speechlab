...
export default async function FeedbackPage({ params }: Props) {
  ...
  console.log('[DEBUG feedback page] rec.status:', rec.status)
  console.log('[DEBUG feedback page] rec.feedback raw:', JSON.stringify(rawFeedback, null, 2))
  ...
  console.log('[DEBUG feedback page] feedbackRow:', JSON.stringify(feedbackRow, null, 2))
  ...
  // Only use feedback if it has actual feedback fields (not just an error object)
    ...
    <main className="container mx-auto max-w-2xl space-y-8 px-4 py-8">
      ...
      {feedback && (
        <>
          ...
          {/* Strengths */}
          {feedback.top_3_strengths?.length > 0 && (
            <section>
          ...
          {/* Improvements */}
          {feedback.top_3_improvements?.length > 0 && (
            <section>
              <h2 className="mb-3 text-sm font-semibold uppercase tracking-wide opacity-60">
